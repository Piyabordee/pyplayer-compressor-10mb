...
- **Auto-open After Save** — Option to automatically open files after saving (configurable in Settings).
- **Enhanced Build System** — Improved compatibility with PyInstaller 5.x and 6.x, with better path resolution and resource management.
...
- **Auto-open After Save:** Option in Settings to auto-open saved files
