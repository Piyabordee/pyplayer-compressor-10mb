# PyPlayer (Modified Fork)

[![Latest Release](https://img.shields.io/github/release/thisismy-github/pyplayer/all.svg)](https://github.com/thisismy-github/pyplayer/releases) [![Download Count](https://img.shields.io/github/downloads/thisismy-github/pyplayer/total?color=success)](https://github.com/thisismy-github/pyplayer/releases/latest)

> **Note:** This is a modified fork of [PyPlayer by thisismy-github](https://github.com/thisismy-github/pyplayer).
> All credit goes to the original author. This version includes custom modifications for personal use.

---

## Changes in This Fork
- **Added always-visible Save button** next to Next button for quick video export
- Save button no longer requires trim mode to be active
- UI layout adjustments for improved workflow
