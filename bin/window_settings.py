...
class Ui_settingsDialog(object):
    def setupUi(self, settingsDialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 403, 3079))
        ...
        self.checkLoadCoverArt = QtWidgets.QCheckBox(self.groupBox_14)
        self.checkLoadCoverArt.setChecked(True)
        self.checkLoadCoverArt.setObjectName("checkLoadCoverArt")
        self.formLayout_14.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.checkLoadCoverArt)
        ...
        self.formLayout_14.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.checkScaleFiltering)
        ...
        self.formLayout_14.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.checkShowCoverArt)
        ...
        self.buttonHoverFontColor = QColorPickerButton(self.groupHover)
...
"        All days in a new year preceding the first Monday are considered to be in week 0.")
        ...
        self.gridLayout_DONTCHANGETHESE.addWidget(self.radioTextPosition4, 2, 0, 1, 1)
        self.radioTextPosition7 = QtWidgets.QRadioButton(self.groupText)
        self.radioTextPosition7.setMinimumSize(QtCore.QSize(16, 16))
        self.radioTextPosition7.setMaximumSize(QtCore.QSize(16, 16))
        self.radioTextPosition7.setObjectName("radioTextPosition7")
        self.gridLayout_DONTCHANGETHESE.addWidget(self.radioTextPosition7, 3, 0, 1, 1)
        ...
        self.gridLayout_DONTCHANGETHESE.addWidget(self.radioTextPosition5, 2, 1, 1, 1)
        ...
        self.gridLayout_DONTCHANGETHESE.addWidget(self.radioTextPosition6, 2, 2, 1, 1)
        ...
        self.gridLayout_DONTCHANGETHESE.addWidget(self.radioTextPosition9, 3, 2, 1, 1)
        ...
        self.radioTextPosition1.setChecked(True)
        self.radioTextPosition1.setObjectName("radioTextPosition1")
        self.gridLayout_DONTCHANGETHESE.addWidget(self.radioTextPosition1, 1, 0, 1, 1)
        ...
        self.gridLayout_DONTCHANGETHESE.addWidget(self.radioTextPosition2, 1, 1, 1, 1)
        self.radioTextPosition3 = QtWidgets.QRadioButton(self.groupText)
        self.radioTextPosition3.setMinimumSize(QtCore.QSize(16, 16))
        self.radioTextPosition3.setMaximumSize(QtCore.QSize(16, 16))
        self.radioTextPosition3.setObjectName("radioTextPosition3")
        self.gridLayout_DONTCHANGETHESE.addWidget(self.radioTextPosition3, 1, 2, 1, 1)
...
"that have already started.")
        ...
        self.formLayout_18.setWidget(5, QtWidgets.QFormLayout.SpanningRole, self.checkRenameMissingImages)
        ...
        self.formLayout_18.setWidget(6, QtWidgets.QFormLayout.SpanningRole, self.checkSaveAsForceOnNoName)
        ...
        self.formLayout_18.setWidget(7, QtWidgets.QFormLayout.SpanningRole, self.checkSaveAsUseMediaFolder)
        ...
        self.formLayout_18.setWidget(8, QtWidgets.QFormLayout.SpanningRole, self.checkCycleRememberOriginalPath)
        spacerItem7 = QtWidgets.QSpacerItem(20, 3, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.formLayout_18.setItem(9, QtWidgets.QFormLayout.SpanningRole, spacerItem7)
        ...
        self.formLayout_18.setWidget(10, QtWidgets.QFormLayout.SpanningRole, self.groupBox_11)
        spacerItem8 = QtWidgets.QSpacerItem(20, 1, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.formLayout_18.setItem(11, QtWidgets.QFormLayout.SpanningRole, spacerItem8)
        ...
        self.formLayout_18.setWidget(12, QtWidgets.QFormLayout.SpanningRole, self.groupBox_10)
        ...
        self.formLayout_9.setItem(2, QtWidgets.QFormLayout.SpanningRole, spacerItem15)
        ...
        self.formKeys.setWidget(37, QtWidgets.QFormLayout.LabelRole, self.label_27)
        ...
        self.formKeys.setLayout(37, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_32)
        self.label_66 = QtWidgets.QLabel(self.tabHotkeys)
        self.label_66.setObjectName("label_66")
        self.formKeys.setWidget(38, QtWidgets.QFormLayout.LabelRole, self.label_66)
        ...
        self.formKeys.setLayout(38, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_39)
        self.label_67 = QtWidgets.QLabel(self.tabHotkeys)
        self.label_67.setObjectName("label_67")
        self.formKeys.setWidget(39, QtWidgets.QFormLayout.LabelRole, self.label_67)
        ...
        self.formKeys.setLayout(39, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_40)
        ...
        self.minusaudiodelay = QKeySequenceFlexibleEdit(self.tabHotkeys)
        self.minusaudiodelay.setObjectName("minusaudiodelay")
        self.horizontalLayout_55.addWidget(self.minusaudiodelay)
        self.minusaudiodelay_ = QKeySequenceFlexibleEdit(self.tabHotkeys)
        self.minusaudiodelay_.setObjectName("minusaudiodelay_")
        self.horizontalLayout_55.addWidget(self.minusaudiodelay_)
        self.formKeys.setLayout(36, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_55)
        self.horizontalLayout_56 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_56.setSpacing(4)
        self.horizontalLayout_56.setObjectName("horizontalLayout_56")
        self.plusaudiodelay = QKeySequenceFlexibleEdit(self.tabHotkeys)
        self.plusaudiodelay.setObjectName("plusaudiodelay")
        self.horizontalLayout_56.addWidget(self.plusaudiodelay)
        self.plusaudiodelay_ = QKeySequenceFlexibleEdit(self.tabHotkeys)
        self.plusaudiodelay_.setObjectName("plusaudiodelay_")
        self.horizontalLayout_56.addWidget(self.plusaudiodelay_)
        self.formKeys.setLayout(35, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_56)
        self.label_28 = QtWidgets.QLabel(self.tabHotkeys)
        self.label_28.setObjectName("label_28")
        self.formKeys.setWidget(36, QtWidgets.QFormLayout.LabelRole, self.label_28)
        self.label_29 = QtWidgets.QLabel(self.tabHotkeys)
        self.label_29.setObjectName("label_29")
        self.formKeys.setWidget(35, QtWidgets.QFormLayout.LabelRole, self.label_29)
        self.label_83 = QtWidgets.QLabel(self.tabHotkeys)
        self.label_83.setObjectName("label_83")
        self.formKeys.setWidget(42, QtWidgets.QFormLayout.LabelRole, self.label_83)
        self.horizontalLayout_54 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_54.setSpacing(4)
        self.horizontalLayout_54.setObjectName("horizontalLayout_54")
        self.properties_ = QKeySequenceFlexibleEdit(self.tabHotkeys)
        self.properties_.setObjectName("properties_")
        self.horizontalLayout_54.addWidget(self.properties_)
        self.properties = QKeySequenceFlexibleEdit(self.tabHotkeys)
        self.properties.setObjectName("properties")
        self.horizontalLayout_54.addWidget(self.properties)
        self.formKeys.setLayout(42, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_54)
        ...
        spacerItem17 = QtWidgets.QSpacerItem(20, 1276, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        settingsDialog.setTabOrder(self.checkTextOnFullScreenPosition, self.radioTextPosition1)
        settingsDialog.setTabOrder(self.radioTextPosition1, self.radioTextPosition2)
        settingsDialog.setTabOrder(self.radioTextPosition2, self.radioTextPosition3)
        settingsDialog.setTabOrder(self.radioTextPosition3, self.radioTextPosition4)
        settingsDialog.setTabOrder(self.radioTextPosition4, self.radioTextPosition5)
        settingsDialog.setTabOrder(self.radioTextPosition5, self.radioTextPosition6)
        settingsDialog.setTabOrder(self.radioTextPosition6, self.radioTextPosition7)
        settingsDialog.setTabOrder(self.radioTextPosition7, self.radioTextPosition8)
        settingsDialog.setTabOrder(self.radioTextPosition8, self.radioTextPosition9)
        settingsDialog.setTabOrder(self.radioTextPosition9, self.scrollArea)
        ...
        settingsDialog.setTabOrder(self.cyclesubtitles_, self.snapshot)
...
"PyPlayer will automatically make this conversion for you,\n"
"and vice versa."))
        self.label_58.setToolTip(_translate("settingsDialog", "The number of recently opened files to\n"
"remember during and between sessions.\n"
"\n"
"Note: At 25 or less, recent files are validated\n"
"on launch to make sure they still exist. Above\n"
"25, they\'re loaded as-is.\n"
"\n"
...
"from the existing list until you play a new file."))
        ...
        self.spinRecentFiles.setToolTip(_translate("settingsDialog", "The number of recently opened files to\n"
"remember during and between sessions.\n"
"\n"
"Note: At 25 or less, recent files are validated\n"
"on launch to make sure they still exist. Above\n"
...
"If not checked, libVLC\'s native updates will be used."))
        self.checkHighPrecisionProgress.setText(_translate("settingsDialog", "High-precision VLC progress slider (CPU-intensive)"))
...
"accident, but I couldn\'t let it go to waste."))
        ...
        self.checkLoadCoverArt.setToolTip(_translate("settingsDialog", "If checked, audio files with embedded cover\n"
"art will have that art loaded into memory.\n"
"\n"
"Note: This setting has a neglible impact\n"
"on opening speed compared to actually\n"
"displaying the art."))
        self.checkLoadCoverArt.setText(_translate("settingsDialog", "Detect cover art"))
...
"nearest-neighbor scaling (when possible)."))
        ...
        self.checkShowCoverArt.setToolTip(_translate("settingsDialog", "If checked, audio files with embedded cover art loaded\n"
"into memory will have that art displayed on the player.\n"
"\n"
"Note: This setting may impact opening speed by as\n"
"much as 20% (which is still essentially nothing)."))
...
"may last longer than this."))
        ...
        self.radioTextPosition4.setToolTip(_translate("settingsDialog", "Left"))
        self.radioTextPosition7.setToolTip(_translate("settingsDialog", "Bottom-Left"))
        self.radioTextPosition5.setToolTip(_translate("settingsDialog", "Center"))
        self.radioTextPosition6.setToolTip(_translate("settingsDialog", "Right"))
        self.radioTextPosition8.setToolTip(_translate("settingsDialog", "Bottom"))
        self.radioTextPosition9.setToolTip(_translate("settingsDialog", "Bottom-Right"))
        self.radioTextPosition1.setToolTip(_translate("settingsDialog", "Top-Left"))
        self.radioTextPosition2.setToolTip(_translate("settingsDialog", "Top"))
        self.radioTextPosition3.setToolTip(_translate("settingsDialog", "Top-Right"))
...
"oldest creation time will be used."))
        ...
        self.checkEditCatPreferCurrentMedia.setToolTip(_translate("settingsDialog", "If checked, always use the currently playing media\'s creation\n"
"and modified time if present in your concatentation list."))
        self.checkEditCatPreferCurrentMedia.setText(_translate("settingsDialog", "Prefer the currently playing media if present"))
...
"mime type as the current media (video, audio, or image)."))
        ...
        self.minusaudiodelay.setKeySequence(_translate("settingsDialog", "Shift+G"))
        self.minusaudiodelay_.setKeySequence(_translate("settingsDialog", "Shift+A"))
        self.plusaudiodelay.setKeySequence(_translate("settingsDialog", "Shift+H"))
        self.plusaudiodelay_.setKeySequence(_translate("settingsDialog", "Alt+A"))
        self.label_28.setText(_translate("settingsDialog", "-50ms audio delay"))
        self.label_29.setText(_translate("settingsDialog", "+50ms audio delay"))
        self.label_83.setText(_translate("settingsDialog", "Properties"))
        self.properties_.setKeySequence(_translate("settingsDialog", "Alt+P"))
